...
<Story name="Text">
    {#snippet template(args)}
        <Buttons.Toggle {...args} variant="text" />
        <Buttons.Toggle {...args} variant="text" shape="squared" />
        <Buttons.Toggle {...args} variant="text" icon="star" />
        <Buttons.Toggle {...args} variant="text" disabled icon="star" />
    {/snippet}
</Story>
